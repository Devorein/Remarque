...
function addExplanation(document, header) {
    ...
    const explanation_lines = [];
        ...
        explanation_line.appendChild(htmlElementCreation(document,{
...
function createAdditionalElem(document) {
	const additionalHTML = `<div class="icon--slider" id="slider-icon">▶</div>
      ...
      <div id="page-extreme-icon">
        <span id="page-extreme-icon--top">▲</span>
        <span id="page-extreme-icon--bottom">▼</span>
      </div>
      `;
