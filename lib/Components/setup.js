...
function initialSetup() {
	...
	window._codeDisplayIcon = document.getElementById('codeDisplayIcon');
	window._downloadCodesIcon = document.getElementById('downloadCodesIcon');
	window._progressIcon = document.getElementById('progressIcon');
	window._clockIcon = document.getElementById('clockIcon');
	window._transferIcon = document.getElementById('transferIcon');
