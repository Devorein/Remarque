/* PrismJS 1.19.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=clike+java&plugins=line-highlight+line-numbers */
	...
	Prism = (function(u) {
		...
		if ((e && ((C.filename = e.src), e.hasAttribute('data-manual') && (C.manual = !0)), !C.manual)) {
			...
			'loading' === t || ('interactive' === t && e && e.defer)
				...
				: window.requestAnimationFrame ? window.requestAnimationFrame(n) : window.setTimeout(n, 16);
		}
		return C;
	})(_self);
