				...
				entries => {
					...
					timer = setTimeout(function() {
						...
						if (_target) {
							...
							const target_pos = _parent.offsetTop,
								current_position = _app_toc_content.scrollTop;
							console.log(target_pos, current_position);
							if (current_position < target_pos)
								while (_app_toc_content.scrollTop + 715 < target_pos) _app_toc_content.scrollBy(0, 50);
							else if (target_pos < current_position) _app_toc_content.scrollBy(0, -target_pos);
						}
					}, 500);
				},
