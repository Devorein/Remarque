window.onload = () => {
  ...
  const tocCodeSearch = document.getElementById('tocCodeSearch');
  ...
  function repositionSlider(id){
	...
	(function scrollIntoViewOutput() {
        ...
        console.log(target.parentElement, CONTENT.scrollTop)
  ...
  (function tocCodeToggle(){
    tocCodeSearch.addEventListener("click",(e)=>{
