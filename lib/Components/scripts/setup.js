...
function toggleClockProgress() {
	// const progressTop = parseInt(_content.scrollTop);
	// const clockTop = parseInt(_content.scrollTop) + parseInt(document.documentElement.clientHeight);
	// if (_progressIcon.classList.contains('activated')) _progressContainer.style.top = `${progressTop - 50}px`;
	// else _progressContainer.style.top = `${progressTop}px`;
	// if (_clockIcon.classList.contains('activated')) _clockContainer.style.top = `${clockTop + 75}px`;
	// else _clockContainer.style.top = `${clockTop}px`;
}
