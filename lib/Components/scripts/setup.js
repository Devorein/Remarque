const { themeToggler, zen_modeHandler, checkForZenMode } = require('./button');
const { showCodeContainerItem } = require('./code');
const { toggleTOCElem, addTOCCheckOnPageLoad } = require('./toc');
const { makeConstantProp, calculateTOC_Content } = require('./utility');
const { play_pause_clockHandler, clockPositionHandler } = require('./clock');
...
function initialSetup() {
	const GLOBAL_ELEMS = {
		...
		_GROUPS                : document.getElementById('groups'),
		...
		_tocSelectedItems      : document.getElementById('tocSelectedItems'),
		...
		_dragIcon              : document.getElementById('dragIcon'),
		_clockPosition         : document.getElementById('clockPosition'),
		_settingsPage          : document.getElementById('settingsPage'),
		_settingsPageCancel    : document.getElementById('settingsPageCancel'),
		_groupsIcon            : document.getElementById('groupsPageIcon'),
		_groupsPageCancel      : document.getElementById('groupsPageCancel')
	};
...
function usePreviousSetup() {
	...
	usePreviousTheme();
	zen_modeHandler();
	showCodeContainerItem();
	addTOCCheckOnPageLoad();
	_tocSelectedItems.textContent = _toc.querySelectorAll('.checked').length;
}
