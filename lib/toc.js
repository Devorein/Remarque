...
global.svgDir = path.join(__dirname, 'Components', 'svgs');
...
const downloadAllIcon = fs.readFileSync(path.join(svgDir, 'downloadAll.svg'));
...
function preprocessTOC() {
	...
	const tocL2Container = htmlElementCreation({
		classes : 'toc--L1'
	});
